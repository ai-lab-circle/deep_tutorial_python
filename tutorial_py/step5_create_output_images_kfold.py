...
caffe_root = 'LOCAL_DIRECTORY/caffe/'
BASE = 'LOCAL_DIRECTORY/public/DL_tutorial_Code/1-nuclei'
FOLD = 1
...
#kyy  add directory (models)
file = open('%s/models/DB_train_w32_%d.binaryproto' % (BASE,FOLD) ,'rb')
data = file.read()
...
#kyy
files=open('%s/test_w32_parent_%d.txt'%(BASE,FOLD),'r')
